    ...
    <section className="profile">
      ...
      <div className="profile-info">
        ...
        <div className="social-icons">
          <a href="https://www.instagram.com/nicolasdonney.29?igsh=amdrbGlpeHR5Z2c2" target="_blank" className="social-icon">
            <i className="fab fa-instagram"></i>
          </a>
          <a href="https://www.facebook.com/profile.php?id=100095024059967&mibextid=ZbWKwL" target="_blank" className="social-icon">
